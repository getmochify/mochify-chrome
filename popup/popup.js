...
// Validate against the API and clear a dead key, otherwise the popup keeps
// showing "signed in" while every request quietly drops to the free limit.
async function validateAndRender() {
  ...
  try {
    const res = await fetch(`${API}/v1/checkTokens`, {
